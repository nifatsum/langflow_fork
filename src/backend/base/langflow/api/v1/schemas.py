...
class InputValueRequest(BaseModel):
    components: list[str] | None = Field(
        ...
        description="(optional) list of component names or ids.",
    )
    input_value: str | None = Field(None, description="(optional) input value.")
    session: str | None = Field(None, description="(optional) target session id.")
