...
async def retrieve_vertices_order(
    *,
    ...
    stop_component_id: str | None = Query(None, description="The ID of the stop component"),
    start_component_id: str | None = Query(None, description="The ID of the start component"),
    session: DbSession,
) -> VerticesOrderResponse:
...
async def build_flow(
    *,
    flow_id: uuid.UUID = Path(..., description="The ID of the target flow."),  # noqa: B008
...
@router.post(
    "/build/{flow_id}/vertices/{vertex_id}",
    deprecated=True,
